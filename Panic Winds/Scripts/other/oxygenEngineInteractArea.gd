...
func _process(_delta): #add flames
	if $"..".playerOwner == GlobalVars.currentPlayer:
		...
		if $"..".InputBind == "InputThree" && !done:
			if Input.is_action_pressed("ThreePressed"):
				if GlobalVars.Oxygen > 1:
		...
		if $"..".InputBind == "InputFour" && !done:
			if Input.is_action_pressed("FourPressed"):
				if GlobalVars.Oxygen > 1:
		...
		if $"..".InputBind == "InputFive" && !done:
			if Input.is_action_pressed("FivePressed"):
				if GlobalVars.Oxygen > 1:
		...
		if $"..".InputBind == "InputSix" && !done:
			if Input.is_action_pressed("SixPressed"):
				if GlobalVars.Oxygen > 1:
		...
		if $"..".InputBind == "InputSeven" && !done:
			if Input.is_action_pressed("SevenPressed"):
				if GlobalVars.Oxygen > 1:
		...
		if $"..".InputBind == "InputEight" && !done:
			if Input.is_action_pressed("EightPressed"):
				if GlobalVars.Oxygen > 1:
		...
		if $"..".InputBind == "InputNine" && !done:
			if Input.is_action_pressed("NinePressed"):
				if GlobalVars.Oxygen > 1:
